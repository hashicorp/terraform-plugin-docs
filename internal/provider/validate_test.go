...
func TestValidateStaticDocs_DirectoryChecks(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"valid registry directories with cdktf docs": {
			ProviderFS: fstest.MapFS{
				"docs/cdktf/typescript/actions/thing.md": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
				...
				"docs/cdktf/typescript/list-resources/thing.md": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
				...
				"docs/cdktf/typescript/state-stores/thing.md": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
		...
		"invalid registry directories": {
			ProviderFS: fstest.MapFS{
				...
				"docs/list-resources/invalid/thing.md": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
				"docs/nonregistrydocs/valid.md": {
					Data: []byte("non-registry documentation"),
				...
				"docs/state-stores/invalid/thing.md": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
				"docs/CONTRIBUTING.md": {
					Data: []byte("contribution guidelines"),
			...
			ExpectedError: "invalid Terraform Provider documentation directory found: " + filepath.Join("docs", "actions", "invalid") +
				...
				"\ninvalid Terraform Provider documentation directory found: " + filepath.Join("docs", "state-stores", "invalid"),
		},
	}
...
func TestValidateStaticDocs_FileChecks(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"invalid action files": {
			ProviderFS: fstest.MapFS{
				"docs/actions/invalid_extension.txt": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
				"docs/actions/invalid_frontmatter.md": &InvalidYAMLFrontMatter,
				"docs/actions/with_layout.md": {
					Data: encodeYAML(t,
						&FrontMatterData{
							Layout:      &exampleLayout,
							Subcategory: &exampleSubcategory,
				...
				"docs/actions/with_sidebar_current.md": {
					Data: encodeYAML(t,
						&FrontMatterData{
							SidebarCurrent: &exampleSidebarCurrent,
							Subcategory:    &exampleSubcategory,
			...
			ExpectedError: filepath.Join("docs", "actions", "invalid_extension.txt") + ": error checking file extension: file does not end with a valid extension, valid extensions: [.md]\n" +
				...
				filepath.Join("docs", "actions", "with_sidebar_current.md") + ": error checking file frontmatter: YAML frontmatter should not contain sidebar_current",
		},
		"invalid list resource files": {
			ProviderFS: fstest.MapFS{
				"docs/list-resources/invalid_extension.txt": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
				"docs/list-resources/invalid_frontmatter.md": &InvalidYAMLFrontMatter,
				"docs/list-resources/with_layout.md": {
					Data: encodeYAML(t,
						&FrontMatterData{
							Layout:      &exampleLayout,
							Subcategory: &exampleSubcategory,
				...
				"docs/list-resources/with_sidebar_current.md": {
					Data: encodeYAML(t,
						&FrontMatterData{
							SidebarCurrent: &exampleSidebarCurrent,
							Subcategory:    &exampleSubcategory,
			...
			ExpectedError: filepath.Join("docs", "list-resources", "invalid_extension.txt") + ": error checking file extension: file does not end with a valid extension, valid extensions: [.md]\n" +
				...
				filepath.Join("docs", "list-resources", "with_sidebar_current.md") + ": error checking file frontmatter: YAML frontmatter should not contain sidebar_current",
		},
		"invalid state store files": {
			ProviderFS: fstest.MapFS{
				"docs/state-stores/invalid_extension.txt": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
				"docs/state-stores/invalid_frontmatter.md": &InvalidYAMLFrontMatter,
				"docs/state-stores/with_layout.md": {
					Data: encodeYAML(t,
						&FrontMatterData{
							Layout:      &exampleLayout,
							Subcategory: &exampleSubcategory,
				...
				"docs/state-stores/with_sidebar_current.md": {
					Data: encodeYAML(t,
						&FrontMatterData{
							SidebarCurrent: &exampleSidebarCurrent,
							Subcategory:    &exampleSubcategory,
			...
			ExpectedError: filepath.Join("docs", "state-stores", "invalid_extension.txt") + ": error checking file extension: file does not end with a valid extension, valid extensions: [.md]\n" +
				...
				filepath.Join("docs", "state-stores", "with_sidebar_current.md") + ": error checking file frontmatter: YAML frontmatter should not contain sidebar_current",
		},
	...
	testCases := map[string]struct {
		...
		"valid - no mismatch": {
			ProviderSchema: &tfjson.ProviderSchema{
				...
				StateStoreSchemas: map[string]*tfjson.Schema{
					"test_state_store": {},
				},
			},
			ProviderFS: fstest.MapFS{
				"docs/actions/action.md": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
				...
				"docs/state-stores/state_store.md": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
			},
		},
		"invalid - missing files": {
			...
			ExpectedError: "missing documentation file for resource: test_id2\n" +
				...
				"missing documentation file for list resource: test_list2\n" +
				"missing documentation file for state store: test_state_store2",
		},
		"invalid - extra files": {
			ProviderSchema: &tfjson.ProviderSchema{
				ActionSchemas: map[string]*tfjson.ActionSchema{
			...
			ProviderFS: fstest.MapFS{
				...
				"docs/state-stores/state_store2.md": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
			},
			ExpectedError: "matching resource for documentation file (id2.md) not found, file is extraneous or incorrectly named\n" +
				...
				"matching list resource for documentation file (list2.md) not found, file is extraneous or incorrectly named\n" +
				"matching state store for documentation file (state_store2.md) not found, file is extraneous or incorrectly named",
		},
	}
...
func TestValidateLegacyWebsite_DirectoryChecks(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"valid legacy directories": {
			ProviderFS: fstest.MapFS{
				"website/docs/actions/thing.html.markdown": {
				...
				"website/docs/list-resources/thing.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
				...
				"website/docs/state-stores/thing.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
		...
		"valid legacy directories with cdktf docs": {
			ProviderFS: fstest.MapFS{
				"website/docs/cdktf/typescript/actions/thing.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
				...
				"website/docs/cdktf/typescript/list-resources/thing.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
				...
				"website/docs/cdktf/typescript/state-stores/thing.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
				"website/docs/index.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyIndexFrontMatter),
		...
		"invalid legacy directories": {
			ProviderFS: fstest.MapFS{
				"website/docs/actions/invalid/thing.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
				...
				"website/docs/list-resources/invalid/thing.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
				...
				"website/docs/state-stores/invalid/thing.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
				"website/docs/index.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyIndexFrontMatter),
			...
			ExpectedError: "invalid Terraform Provider documentation directory found: " + filepath.Join("website", "docs", "actions", "invalid") +
				...
				"\ninvalid Terraform Provider documentation directory found: " + filepath.Join("website", "docs", "state-stores", "invalid"),
		},
	}
...
func TestValidateLegacyWebsite_FileChecks(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"invalid state store files": {
			ProviderFS: fstest.MapFS{
				"website/docs/state-stores/invalid_extension.txt": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
				"website/docs/state-stores/invalid_frontmatter.html.markdown": &InvalidYAMLFrontMatter,
				"website/docs/state-stores/without_layout.html.markdown": {
					Data: encodeYAML(t,
						&FrontMatterData{
							Subcategory: &exampleSubcategory,
							PageTitle:   &examplePageTitle,
				...
				"website/docs/state-stores/with_sidebar_current.html.markdown": {
					Data: encodeYAML(t,
						&FrontMatterData{
							SidebarCurrent: &exampleSidebarCurrent,
							Subcategory:    &exampleSubcategory,
			...
			ExpectedError: filepath.Join("website", "docs", "state-stores", "invalid_extension.txt") + ": error checking file extension: file does not end with a valid extension, valid extensions: [.html.markdown .html.md .markdown .md]\n" +
				...
				filepath.Join("website", "docs", "state-stores", "without_layout.html.markdown") + ": error checking file frontmatter: YAML frontmatter missing required layout",
		},
		"invalid list resource files": {
			ProviderFS: fstest.MapFS{
				"website/docs/list-resources/invalid_extension.txt": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
				"website/docs/list-resources/invalid_frontmatter.html.markdown": &InvalidYAMLFrontMatter,
				"website/docs/list-resources/without_layout.html.markdown": {
					Data: encodeYAML(t,
						&FrontMatterData{
							Subcategory: &exampleSubcategory,
							PageTitle:   &examplePageTitle,
				...
				"website/docs/list-resources/with_sidebar_current.html.markdown": {
					Data: encodeYAML(t,
						&FrontMatterData{
							SidebarCurrent: &exampleSidebarCurrent,
							Subcategory:    &exampleSubcategory,
			...
			ExpectedError: filepath.Join("website", "docs", "list-resources", "invalid_extension.txt") + ": error checking file extension: file does not end with a valid extension, valid extensions: [.html.markdown .html.md .markdown .md]\n" +
				...
				filepath.Join("website", "docs", "list-resources", "without_layout.html.markdown") + ": error checking file frontmatter: YAML frontmatter missing required layout",
		},
		"invalid action files": {
			ProviderFS: fstest.MapFS{
				"website/docs/actions/invalid_extension.txt": {
					Data: encodeYAML(t, &ValidRegistryResourceFrontMatter),
				},
				"website/docs/actions/invalid_frontmatter.html.markdown": &InvalidYAMLFrontMatter,
				"website/docs/actions/without_layout.html.markdown": {
					Data: encodeYAML(t,
						&FrontMatterData{
							Subcategory: &exampleSubcategory,
							PageTitle:   &examplePageTitle,
				...
				"website/docs/actions/with_sidebar_current.html.markdown": {
					Data: encodeYAML(t,
						&FrontMatterData{
							SidebarCurrent: &exampleSidebarCurrent,
							Subcategory:    &exampleSubcategory,
			...
			ExpectedError: filepath.Join("website", "docs", "actions", "invalid_extension.txt") + ": error checking file extension: file does not end with a valid extension, valid extensions: [.html.markdown .html.md .markdown .md]\n" +
				...
				filepath.Join("website", "docs", "actions", "without_layout.html.markdown") + ": error checking file frontmatter: YAML frontmatter missing required layout",
		},
		"invalid resource files": {
			ProviderFS: fstest.MapFS{
	...
	testCases := map[string]struct {
		...
		"valid - no mismatch": {
			...
			ProviderFS: fstest.MapFS{
				...
				"website/docs/list-resources/list.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
				...
				"website/docs/state-stores/state_store.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
			},
		},
		...
		"invalid - extra files": {
			...
			ProviderFS: fstest.MapFS{
				...
				"website/docs/actions/action2.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
				"website/docs/d/pet.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				...
				"website/docs/list-resources/list2.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
				"website/docs/r/id.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				...
				"website/docs/state-stores/state_store2.html.markdown": {
					Data: encodeYAML(t, &ValidLegacyResourceFrontMatter),
				},
			},
