...
The `validate` subcommand can be used to validate the provider website documentation against the Terraform Registry's guidelines and provider documentation best practices. The current checks in the validate command are:
